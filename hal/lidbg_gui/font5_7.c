...
****************************************************************************/
U8  GUI_PutChar5_7(U32 x, U32 y, U8 ch)
{
    U8   font_dat;
    U8   i, j;
    TCOLOR  bakc;
    ...
    for(i = 0; i < 8; i++)
    {
        ...
        for(j = 0; j < 6; j++)
        {
            ...
            if( (font_dat & DCB2HEX_TAB[j]) == 0 )
            {
                ...
                //RETAILMSG(MSG_DEBUG, (TEXT("1")));
            }

            else
            {
                GUI_CopyColor(&bakc, disp_color);
                //RETAILMSG(MSG_DEBUG, (TEXT("0")));
            }
            GUI_Point(x, y, bakc);
            x++;
        }
...
****************************************************************************/
void  GUI_PutString5_7(U32 x, U32 y, char *str)
{
    while(1)
    {
        if( (*str) == '\0' ) break;
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_PutNoStr5_7(U32 x, U32 y, char *str, U8 no)
{
    if(no == 0) return;
    for(; no > 0; no--)
    {
